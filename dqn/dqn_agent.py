...
class DQNAgent:
    ...
    def save(self):
        ...
        torch.save(self.Q_network.state_dict(), f"saved_networks/dqn/{self.env_name}/Q_network.pt")

    def load(self):
        self.Q_network.load_state_dict(torch.load(f"saved_networks/dqn/{self.env_name}/Q_network.pt"))
