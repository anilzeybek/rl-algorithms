...
class DQNAgent:
    ...
    def save(self):
        os.makedirs(f"saved_networks/dqn/{self.env_name}", exist_ok=True)
        torch.save({
            "Q_network": self.Q_network.state_dict(),
            "eps": self.eps
        }, f"saved_networks/dqn/{self.env_name}/Q_network.pt")

        self.rb.save_transitions(f"saved_networks/dqn/{self.env_name}/rb.npz")

    def load(self):
        checkpoint = torch.load(f"saved_networks/dqn/{self.env_name}/Q_network.pt")
        ...
        self.rb.load_transitions(f"saved_networks/dqn/{self.env_name}/rb.npz")
